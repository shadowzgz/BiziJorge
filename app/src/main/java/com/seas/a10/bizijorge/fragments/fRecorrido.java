...
public class fRecorrido extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tvNoRecorrido = (TextView) v.findViewById(R.id.tvNoRecorrido);
        tvNoRecorrido.setVisibility(View.INVISIBLE);
        ...
        //Si tenemos algún recorrido en la lista, instanciamos el RecyclerView, si no mostramos un mensaje de advertencia
        if (listadoRecorridos != null){
            if (listadoRecorridos.size() > 0) {
            ...
            rvListadoRecorridos.setVisibility(View.INVISIBLE);
            tvNoRecorrido.setVisibility(View.VISIBLE);
            tvNoRecorrido.setText("*No se ha encontrado ningún recorrido para este usuario.");
        }
        return v;
    }
